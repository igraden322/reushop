...
<div class="clothes-view">
    ...
    <div class="description">
         ...
         <div id="description"> 
           ...
           <h5> Вес: <?= Html::encode($model->weigth)?> </h4><br><br>
           <h5> Осталось на складе: <?= Html::encode($model->count)?> </h4><br><br>
           <form action="/index.php">
            ...
            <?php if(!Yii::$app->user->isGuest)
                echo '<a href="/index.php?r=souvenirs%2Findex">Для разработчиков</a>';
               ?>
         </div>
    </div>
